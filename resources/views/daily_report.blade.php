            ...
            <div class="form-group form-datepicker header-group-0 " id="form-group-start_date" style="">
                ...
                <div class="col-sm-10">
                    <div class="input-group">
                        ...
                        <input type="text" title="Start Date" readonly="" class="form-control notfocus input_date"
                            name="date_select" id="date_select" value="{{$params['date_select']}}">
                    </div>
    ...
    <div id="tab01" class="tab-contents">
        <div class="col-sm-12">
            ...
            <div class="col-sm-7 text-center">
                <div class="day-item">
                    <h4 class="">{{date('D',strtotime($year.'-'.$month.'-'.$day)).'-'.$day}}</h4>
                    <h5> Total Order: {{number_format($orders[$year.'-'.$month.'-'.str_pad($day, 2, '0', STR_PAD_LEFT)]->total_order)}}</h5>
                    <h5> Total Sale: {{number_format($orders[$year.'-'.$month.'-'.str_pad($day, 2, '0', STR_PAD_LEFT)]->sum_grand_total, 2)}}</h5>
                </div>
            </div>
            <?php $day++?>
        ...
        <table class="table table-dark datatable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">{{$year.'-'.$month.'-'.str_pad($day, 2, '0', STR_PAD_LEFT)}}</td>
                    <td class="text-center">{{number_format($orders[$year.'-'.$month.'-'.str_pad($day, 2, '0', STR_PAD_LEFT)]->total_order)}}</td>
                    <td class="text-center">{{number_format($orders[$year.'-'.$month.'-'.str_pad($day, 2, '0', STR_PAD_LEFT)]->sum_grand_total, 2)}}</td>
                </tr>
                <?php $day++?>
